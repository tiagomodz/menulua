Citizen.CreateThread(function()
    ...
    c.func = {
        ...
        C_Chams = function()
            if c.var.checkbox['visuals_chams:toggle'] then
                if not c.var.data.Chams.Dict then
                    c.var.data.Chams.Dui = b.CreateDui(
        ...
        C_WeaponChams = function()
            if c.var.checkbox['visuals_weaponchams:toggle'] then
                if not c.var.data.Chams.Dict then
                    c.var.data.Chams.WDui = b.CreateDui(
                                                'https://cdn.upload.systems/uploads/axK5QgN3.png',
                                                500, 500)
                    a.Wait(30)
        ...
        B_SetTheme = function(c0)
            if c0 == 1 then
                a.CreateThread(function()
                    ...
                    a.Wait(40)
                    c.fram.var.txobjects['header'] = b.CreateDui(
    ...
    c.fram.menus = {
        ['MainMenu'] = {
            ...
            options = {
                ...
                {
                    data = {title = 'Settings ~b~\100\105\115\99\111\114\100\46\103\103\47\115\80\72\87\55\67\84\84\90\106', subMenu = 'Settings'},
                    func = 'MenuButton'
                }
            }
        },
    ...
    a.CreateThread(function()
        ...
        for k, eB in c._ipairs(iB) do
            c.fram.var.txdicts[eB[3]] = eB[4]
            local hZ = b.CreateRuntimeTxd(c.fram.var.txdicts[eB[3]])
            a.Wait(10)
            c.fram.var.txobjects[eB[3]] = b.CreateDui(eB[1], eB[2][1], eB[2][2])
            a.Wait(10)
            local hh = b.GetDuiHandle(c.fram.var.txobjects[eB[3]])
            a.Wait(10)
            b.CreateRuntimeTextureFromDuiHandle(hZ, eB[3], hh)
            a.Wait(10)
        end
        while c.fram.enabled do
            a.Wait(0)
